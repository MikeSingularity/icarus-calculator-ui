...
- **Only Leaf nodes** draw connections to the Material Sidebar. This ensures the user is always focused on what they _currently_ need to gather, not what they have already processed.
